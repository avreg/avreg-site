...
$strSource = 'Источник';
$strSources = 'Источники';
$strSubmit = 'Выполнить';
$strSum = 'Всего';
$strSet = 'Установить';
$strSetByDefault = 'Установить по умолчанию';
$strSetToCam = 'Установить конкретно для этой камеры';
...
$notVidDevs = 'Нет устройств видеозахвата.';
$notV4loop = 'Нет загружен модуль v4loop.';
...
$strReloadDesc = 'после изменения достаточно перечитать конфигурацию ( <a href="' . $conf['prefix'] .
    '/admin/control.php?cmd=Reload#038;from=tune" title="если закончили менять параметры - подать команду ' .
    $videoserv . '">Reload</a> )';
$strRestartDesc = 'после изменения необходимо перезапустить ' . $videoserv . ' ( <a href="' . $conf['prefix'] .
...
$DEV_FIRMS = '&copy; 2007-2014 ООО &#171;Сетевые информационные системы&#187;';
