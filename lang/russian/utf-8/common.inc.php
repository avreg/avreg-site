...
$grp_ar = array(
	...
	2 => array(
		...
		'grdesc' => 'Почти полный доступ за исключением добавления/удаления камер и изменения большинства специфических настроек камер.'
	),
	3 => array(
	...
	4 => array(
		...
		'grdesc' => 'Mогут наблюдать за камерами в реальном времени и управлять ими (вкл./выкл. режима принудительной записи, PTZ).'
	),
