...
//						console.log(error.message);
            ...
            FormatTimeReally : function(tCur, ElNum){
				...
				tempDate = nDate.split(' ');
				NewDate[0] = tempDate[1];
				NewDate[1] = tempDate[0];
				return NewDate;
                ...
                NewDate[1] =  dateObject.getFullYear() + '/' +
				...
				console.log(NewDate,dateObject.getFullYear(),dateObject.getMonth(), dateObject.getDay());
                return NewDate;
            },
