...
vlcPlayer = {
    ...
    playClickHandler : function (numPlayer, time){
        ...
        try{
            ...
            console.log("Play----> vlcPlayer.retIdMediaElem == "+ vlcPlayer.retIdMediaElem(numPlayer));


            vlcObj.playlist.play();

            console.log("Play---->zzzzzzzzzzzzzzzz");
            ...
            console.log("Play cathc---->");

            console.log("Play cathc---->2");
            console.log(vlcObj);
